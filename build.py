...
def service_page(slug, h1, title, desc, when, body_html, faqs=None, img=None, img_alt=""):
    ...
    img_html = ""
    if img:
        img_html = f'<section style="padding:44px 0 0"><div class="wrap"><img class="imgframe" style="max-height:620px;width:auto;max-width:100%;margin:0 auto;border-width:3px" src="{img}" alt="{esc(img_alt)}" loading="lazy"></div></section>'
    faq_html = ""
    if faqs:
...
<section class="dark" style="padding:0">
  <div class="photostrip">
    <figure><img src="/assets/photos/strip-ink.jpg" style="object-position:center 42%" alt="Squeegee and ink on a screen printing press" loading="lazy"><figcaption>ink.</figcaption></figure>
    ...
    <figure><img src="/assets/photos/strip-heatpress.jpg" style="object-position:center 28%" alt="Heat press at fusion station one" loading="lazy"><figcaption>heat.</figcaption></figure>
