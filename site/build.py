...
.photostrip img{width:100%;height:100%;object-fit:cover;aspect-ratio:4/3}
...
def service_page(slug, h1, title, desc, when, body_html, faqs=None, img=None, img_alt=""):
    ...
    img_html = ""
    if img:
        img_html = f'<section style="padding:0"><img class="imgframe" style="width:100%;max-height:520px;object-fit:cover;border-left:0;border-right:0" src="{img}" alt="{esc(img_alt)}" loading="lazy"></section>'
    faq_html = ""
    if faqs:
...
def home():
    ...
    body = f"""
<section class="hero photo" style="--hero-img:url('/assets/photos/hero-washout.jpg')">
  <div class="wrap">
...
<div class="marquee" aria-hidden="true"><div class="track"><span>we can do that.</span><span>good people. great gear.</span><span>you think it, we'll ink it.</span><span>since 1987.</span><span>we can do that.</span><span>good people. great gear.</span><span>you think it, we'll ink it.</span><span>since 1987.</span></div></div>
<section>
  <div class="wrap">
...
<section class="dark" style="padding:0">
  <div class="photostrip">
    <figure><img src="/assets/photos/strip-ink.jpg" alt="Squeegee and ink on a screen printing press" loading="lazy"><figcaption>ink.</figcaption></figure>
    <figure><img src="/assets/photos/strip-embroidery.jpg" alt="Embroidery machine stitching a logo" loading="lazy"><figcaption>thread.</figcaption></figure>
    <figure><img src="/assets/photos/strip-heatpress.jpg" alt="Heat press at fusion station one" loading="lazy"><figcaption>heat.</figcaption></figure>
    <figure><img src="/assets/photos/strip-shop.jpg" alt="The P&amp;M Apparel production floor" loading="lazy"><figcaption>the floor.</figcaption></figure>
  </div>
</section>
...
<section class="dark">
  <div class="wrap">
    <p class="eyebrow">find your method</p>
...
(function(){{
  ...
  function done(){{
    ...
    body.innerHTML="<div class='quiz-result'><p class='eyebrow' style='color:#6b6b6b'>your method</p><h3>"+r.t+"</h3><p class='cellsub'>"+r.d+"</p><div class='btn-row' style='margin-top:6px'><a class='cta-btn inv' href='"+r.u+"'>see how it works.</a><a class='cta-btn inv' style='background:#fff;color:#1a1a1a' href='{QUOTE_URL}'>get a quote.</a></div></div>";
  }}
...
<p>Standard turnaround is 8 to 10 business days after art approval (up to 12 in peak season). We print on Gildan, Bella+Canvas, Comfort Colors, Carhartt, Nike, Adidas, Under Armour, and more. Pantone color matching available. Every job gets a quote approval and a proof approval before anything prints.</p>""",
        ...
        ], img="/assets/photos/svc-screenprint.jpg", img_alt="Automatic screen printing press with a shirt loaded at P&M Apparel")
...
<p>Our embroidery technicians color-match thread to existing logos on request, and you're always welcome to choose thread colors yourself. Hats, thick knits, and technical fabrics each have quirks; we'll flag anything before we stitch. Every job gets a proof approval first.</p>""",
        ...
        ], img="/assets/photos/svc-embroidery.jpg", img_alt="Multi-needle embroidery machine stitching a logo onto a polo")
...
<p>Fusion plays well with everything else we do. Screen print the front, fusion the personalized names on the back. Add glitter numbers to sublimated jerseys. Your account manager will spec the combination that fits your design and budget.</p>""",
        ...
        ], img="/assets/photos/svc-fusion.jpg", img_alt="Heat press at P&M Apparel's fusion station")
